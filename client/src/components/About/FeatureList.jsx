...
export const featuresList = [
  {
    ...
    desc: `LMS instructors are real people who are passionate about sharing what they know with students all over the world.`,
    icon: (
      <svg
  ...
  },
  {
    ...
    desc: `Whatever your learning style, we have a course that fits. Coming from instructors all over the world, our courses span over 75 languages and cover just about anything you’d want to know.`,
    icon: (
      <svg
        style={{ width: "2rem", height: "2rem" }}
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    desc: `Talented people are everywhere, but opportunities can be harder to find. With LMS, Mohammed — a Syrian refugee — was able to start a new career and a new life in Germany.`,
    icon: (
      <svg
        style={{ width: "2rem", height: "2rem" }}
        viewBox="0 0 24 24"
...
const FeatureList = () => {
  return (
    <Container maxW="100%" py={8} px={{ base: 5, md: 10 }}>
      <Box
        maxW={{ base: "64rem", xl: "90%" }}
        marginX="auto"
